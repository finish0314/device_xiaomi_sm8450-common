...
import com.xiaomi.parts.autohbm.AutoHbmActivity;
import com.xiaomi.parts.autohbm.HbmTileService;
import com.xiaomi.parts.autohbm.AutoHbmTileService;
import com.xiaomi.parts.gameoverlay.GameOverlaySettingsActivity;
import com.xiaomi.parts.gameoverlay.GameOverlayTileService;
...
public final class TileHandlerActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (TILE_ACTIVITY_MAP.containsKey(qsName)) {
            ...
            Log.d(TAG, "Launching activity for QS tile: " + qsName);
        } else {
